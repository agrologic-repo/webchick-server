...
public class AddFuelDialog extends JDialog {
     ...
     */
    public AddFuelDialog(Frame parent, boolean modal) {
        ...
        tblDataTable.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1) {
                    ...
                    currFuel = flockService.getFuelById(id);
                    setForm(currFuel);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Fuel fuel = getFromFields();
        flockService.addFuel(fuel);
        loadFuel(flockId);
        clearForm();
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        flockService.removeFuel(currFuel.getId());
        loadFuel(flockId);
        clearForm();
    ...
    private void loadFuel(Long flockId) {
        ...
        List<Fuel> fuelList = flockService.getAllFuel(flockId);
        for (Fuel g : fuelList) {
    ...
    private Fuel getFromFields() {
        ...
        currFuel = new Fuel();
        currFuel.setAmount(Integer.parseInt(amount));
        currFuel.setDate(date);
        currFuel.setFlockId(flockId);
        currFuel.setNumberAccount(Integer.parseInt(accountNumber));
        currFuel.setPrice(Float.parseFloat(price));
        currFuel.setTotal(Float.parseFloat(total));
        return currFuel;
    }
    ...
    private void setForm(Fuel fuel) {
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddFuelDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                AddFuelDialog dialog = new AddFuelDialog(new javax.swing.JFrame(), true);
