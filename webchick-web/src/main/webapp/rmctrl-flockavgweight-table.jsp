<%--
    Document   : rmctrl-flockavgweight-table.jsp
    Created on : Jan 25, 2011, 8:54:20 AM
...
<body>
<form action="./rmctrl-flockavgweight-table.jsp">
