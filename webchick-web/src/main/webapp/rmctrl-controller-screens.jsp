                        ...
                        <td align="center" valign="top">
                            <table border="0" width="100%" id="topnav">
                                ...
                                <tr>
                                    ...
                                    <td nowrap align="center">
                                        <a class="<%=cssClass%>"
                                           href="./rmtctrl-screens.html?lang=<%=lang%>&userId=<%=userId%>&cellinkId=<%=controller.getCellinkId()%>&programId=<%=controller.getProgramId()%>&screenId=<%=screen.getId()%>&controllerId=<%=controller.getId()%>&doResetTimeout=true"
                                           id="<%=screen.getId()%>"
                                           onclick='document.body.style.cursor = "wait"'><%=screen.getUnicodeTitle()%>
                                        </a>
                                    </td>
                ...
                <table cellPadding="2" cellSpacing="2" align="center">
                    ...
                    <tr>
                        ...
                        <td valign="top" colspan="8">
                            <table class="table-list" width="100%" align=left border="1" borderColor="#848C96"
