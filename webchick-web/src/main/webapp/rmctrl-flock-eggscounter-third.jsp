...
<%
    ...
    //////////////////////////////////////////////////Daily Graphs/////////////////////////////////////////////////////         !!!!!!!!!!!!!!!!!!!!!!!!!!!!
    String filenameaw = GenerateGraph.generateChartFlockEggsCounterThird(flockId, fromDay.toString(), toDay.toString(), session, new PrintWriter(out), currLocal);
    String graphURLAW;
                        ...
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph"
                                      action="./rmctrl-flock-eggscounter-third.jsp?currLocal=<%=currLocal%>"
...
<script>
    $("#btnClear").click(function () {
        window.location.href = "./rmctrl-flock-eggscounter-third.jsp?currLocal=<%=currLocal%>&flockId=<%=flockId%>";   /////////////////////////////////////////
    });
