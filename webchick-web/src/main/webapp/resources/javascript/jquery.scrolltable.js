...
(function ($) {
    $.widget("ui.scrolltable", {
        ...
        _convertTable: function ($container) {
            ...
            var $head = $('<table class="st-head-table" cellpadding="0" cellspacing="0" border="0" />')
                .append($container.find('>thead')).css('width', '100%');
            var $body = $('<table class="st-body-table" cellpadding="0" cellspacing="0" border="0" />')
                .append($container.find('>tbody')).css('width', '100%');

            $container
                .addClass('st-container')
                .html('<thead><tr><td class="st-head"></td></tr></thead><tbody><tr><td class="st-body">' +
                    '<div class="st-body-scroll"></div></td></tr></tbody>')
                .find('.st-head').css('padding', '0 0 20px 0').append($head).end()
                .find('.st-body').css('padding', '0 0 0 0')
