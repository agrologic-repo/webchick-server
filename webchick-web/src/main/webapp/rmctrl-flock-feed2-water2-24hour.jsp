...
<%
    ...
    //////////////////////////////////////////////////24 Hour Graphs/////////////////////////////////////////////////////
    filenamewft = GenerateGraph.generateChartFlockFeed2Water2(flockId, growDay.toString(), session, new PrintWriter(out), currLocal);
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph"action="./rmctrl-flock-feed-water-24hour.jsp?currLocal=<%=currLocal%>" style="display: inline-block">
                            ...
                            <td valign="top">
                                <button id="showTable" onclick="window.open('./rmctrl-flockhistory24-table.jsp?flockId=<%=flockId%>&growDay=<%=growDay%>', 'mywindow','width=800,height=600,toolbar=no,location=yes,directories=no,status=no,menubar=no,scrollbars=yes,copyhistory=yes, resizable=yes')">
                                ...
                                <button id="exportExcel"><%=session.getAttribute("button.export")%><img id="exportToExcel" name="exportToExcel" src="resources/images/excel.gif" style="cursor: pointer; vertical-align: bottom" hspace="5" border="0"/></button>
                ...
                <td width="100%">
                    <div id="graph" class="ui-accordion ui-corner-all">
                        <table border="0" cellpadding="0" cellspacing="0" style="padding:1px;">
                            <tr><td colspan="2" width="80%"><img src="<%=graphURLWFT%>" usemap="#<%=filenamewft%>"></td></tr>
                        </table>
                    </div>
                </td>
            </tr>
