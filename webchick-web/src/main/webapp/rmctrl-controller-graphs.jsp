...
//    if(controller.getProgram().getId() == 110803){
...
//        }
//
//        filenamewft = GenerateGraph.generateChartWaterFeedTempSpecial(controllerId, session, new PrintWriter(out), currLocal);
//        if (filenameth.contains("public_error")) {
...
//        }
//
//        filenamefwpb = GenerateGraph.generateChartFeedWaterPerBird24Special(controllerId, session, new PrintWriter(out), currLocal);
//        if (filenameth.contains("public_error")) {
...
//        }
//
//        filenamef2w2pb = GenerateGraph.generateChartFeed2Water2_24Special(controllerId, session, new PrintWriter(out), currLocal);
//        if (filenameth.contains("public_error")) {
...
//        }
//
//        filenamewspb = GenerateGraph.generateChartWaterSum_24Special(controllerId, session, new PrintWriter(out), currLocal);
//        if (filenameth.contains("public_error")) {
