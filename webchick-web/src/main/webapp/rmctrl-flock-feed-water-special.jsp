...
<div id="contentDiv" class="contentClass" style="width: 100%">
    <fieldset style="-moz-border-radius:5px;  border-radius: 5px;  -webkit-border-radius: 5px;">
        <table width="100%">
                        ...
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph"
                                      action="./rmctrl-flock-feed-water-special.jsp?currLocal=<%=currLocal%>"
            ...
            <%
                String filenamefw = GenerateGraph.generateChartFlockWaterFeedSpecial(flockId, fromDay.toString(), toDay.toString(),session, new PrintWriter(out), currLocal);
                String graphURLWF;
