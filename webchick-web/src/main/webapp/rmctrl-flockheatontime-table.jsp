<%--
    Document   : rmctrl-flockmortality-table.jsp
    Created on : Jan 25, 2011, 5:51:28 PM
...
<body>
<form action="./rmctrl-flockheatontime-table.jsp">
