...
<%
    ...
    //////////////////////////////////////////////////Daily Graphs/////////////////////////////////////////////////////
    String filenameaw = GenerateGraph.generateChartFlockEggsCounterEighth(flockId, fromDay.toString(), toDay.toString(), session, new PrintWriter(out), currLocal);
    String graphURLAW;
                        ...
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph"
                                      action="./rmctrl-flock-eggscounter-eighth.jsp?currLocal=<%=currLocal%>"
...
<script>
    $("#btnClear").click(function () {
        window.location.href = "./rmctrl-flock-eggscounter-eighth.jsp?currLocal=<%=currLocal%>&flockId=<%=flockId%>";
    });
