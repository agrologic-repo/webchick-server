                    ...
                    <%}%>
                        ...
                        <td>
                            ...
                            <img src="resources/images/online.gif" onmouseover="this.src='resources/images/honline.gif'"
                                 ...
                                 onclick="redirect('./rmctrl-main-screen-ajax.jsp?userId=<%=cellink.getUserId()%>&cellinkId=<%=cellink.getId()%>&screenId=1&doResetTimeout=true')"/>
                            ...
                            <img src="resources/images/running.gif"
                                 ...
                                 onclick="window.location.href = './all-cellinks.html?userId=<%=cellink.getUserId()%>&cellinkId=<%=cellink.getId()%>&screenId=1&doResetTimeout=true'"/>
                            <%} else {%>
