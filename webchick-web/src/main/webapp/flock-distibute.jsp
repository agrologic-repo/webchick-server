...
<%
    ...
    Flock distributeFlock = (Flock) session.getAttribute("flock");
%>
<!DOCTYPE html>
<html>
<head>
            ...
            <fieldset style="-moz-border-radius:5px;  border-radius: 5px;  -webkit-border-radius: 5px;">
                ...
                <table border="1" style="width: 000px;border:1px solid #C6C6C6; border-collapse: collapse;">
                    <tr>
                        ...
                        <td align="center"><input type="text" readonly value="<%=distributeFlock.getFeedAdd() %>">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Total Slaughter Female</th>
                        <td align="center"><input type="text" readonly value="<%=distributeFlock.getTotalFeed() %>">
                        </td>
                    </tr>
                    <tr>
