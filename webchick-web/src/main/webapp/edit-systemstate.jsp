...
<table class="main" align="center" cellpadding="0" cellspacing="0" border="0" width="100%" style="padding:10px">
    <tr>
        <td>
            ...
            <h2>edit system state </h2>

            <form id="addForm" name="addForm" action="./edit-systemstate.html" method="post"
                ...
                <table width="100%" align="left" border="0">
                    ...
                    <tr>
                        <td align="left"><input id="Ntext" type="text" name="Ntext" value="<%=systemstateName%>">&nbsp;
                        </td>
                    </tr>
                    <tr>
