...
<%
    ...
    //////////////////////////////////////////////////Daily Graphs/////////////////////////////////////////////////////
    String filenamem = GenerateGraph.generateChartFlockRequiredTemperature(flockId, fromDay.toString(), toDay.toString(), session, new PrintWriter(out), currLocal);
    String graphURLM;
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph" action="./rmctrl-flock-required-temperature.jsp?currLocal=<%=currLocal%>" style="display: inline-block">
                            ...
                            <td valign="top">
                                ...
                                <button id="exportExcel"><%=session.getAttribute("button.export")%><img id="exportToExcel"name="exportToExcel" src="resources/images/excel.gif" style="cursor: pointer; vertical-align: bottom" hspace="5" border="0"/>
                                </button>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="padding:1px;">
                            <tr>
                                <td colspan="2" width="80%">
                                    <img src="<%=graphURLM%>" usemap="#<%=filenamem%>">
                                </td>
                            </tr>
                        </table>
                    </div>
