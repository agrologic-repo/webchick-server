...
<%
    ...
    //////////////////////////////////////////////////Daily Graphs/////////////////////////////////////////////////////
    String filenamem = GenerateGraph.generateChartStandartDeviation(flockId, fromDay.toString(), toDay.toString(), session, new PrintWriter(out), currLocal);
    String graphURLM;
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td>
                                <form id="flock-graph" name="flock-graph" class="flock-graph" action="./rmctrl-flock-standard-deviation.jsp?currLocal=<%=currLocal%>" style="display: inline-block">
