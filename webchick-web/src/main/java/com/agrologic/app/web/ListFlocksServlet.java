...
//                        // 01/03/2018
                    ...
                    request.getRequestDispatcher("./rmctrl-controller-flocks.jsp?userId=" + userId + "&celinkId=" + cellinkId).forward(request, response);
...
//                    Integer lastInt = flockDao.getUpdatedGrowDayHistory(f.getFlockId());
//                    Date last = addDays(startDate, lastInt);
//                    f.setStatus("Close");
////                    f.setEndDate(sdf.format(currentDay));
//                    f.setEndDate(sdf.format(last));
