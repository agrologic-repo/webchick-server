 ...
 * @version     1.1 <br>
 */
public class ProgramRelayDto implements Serializable {
...
//  }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProgramRelayDto)) {
            return false;
        }

        ProgramRelayDto programRelay = (ProgramRelayDto) o;

        return new EqualsBuilder().append(this.text, programRelay.text).append(this.index,
                                          programRelay.index).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(this.text).append(this.index).toHashCode();
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this).append(this.text).append(this.index).toString();
    }
}
