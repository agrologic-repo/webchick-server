...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    static {
        try {
            PropertyResourceBundle resources =
                (PropertyResourceBundle) ResourceBundle.getBundle("com.agrologic.app.gui.wizard.wizard");
    ...
    public Wizard(Dialog owner) {
        ...
        wizardDialog.setPreferredSize(new Dimension(600, 450));
        initComponents();
    }
    ...
    public Wizard(Frame owner) {
        wizardModel  = new WizardModel();
        wizardDialog = new JDialog((Frame) null);
        wizardDialog.setBounds(0, 0, 600, 430);
        initComponents();
        Windows.centerOnScreen(wizardDialog);
    }

    /**
     * Returns an instance of the JDialog that this class created. This is useful in the event that you want to change
     * any of the JDialog parameters manually.
     *
     ...
     *
     * @return The owner (java.awt.Frame or java.awt.Dialog) of the javax.swing.JDialog generated by this class.
     */
    ...
    public int showModalDialog() {
        ...
        // ((Frame) wizardDialog.getOwner()).setBounds(0, 0, 1800, 600);
        wizardDialog.pack();
        wizardDialog.show();
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("com.agrologic.app.gui.wizard.Wizard");
