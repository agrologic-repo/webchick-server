...
public interface ProgramSystemStateDao {
     ...
     * @throws java.sql.SQLException if failed to update the programSystemState in the database
     */
     ...
     * @throws java.sql.SQLException if failed to remove the programSystemState from the database
     */
     ...
     * @throws java.sql.SQLException if failed to insert the program system state list to the database
     */
