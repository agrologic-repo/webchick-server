...
public interface ProgramDao {
     ...
     * @throws java.sql.SQLException if failed to insert new program to the database
     */
     ...
     * @throws java.sql.SQLException if failed to update the program in the database
     */
     ...
     * @throws java.sql.SQLException if failed to remove the program from the database
     */
     ...
     * @throws java.sql.SQLException if failed to retrieve program from the database
     */
     ...
     * @throws java.sql.SQLException if failed to retrieve all Program from the database
     */
