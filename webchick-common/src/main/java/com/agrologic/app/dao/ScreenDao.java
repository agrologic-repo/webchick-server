...
public interface ScreenDao {
     ...
     *
     * @param screenList the screen list
     * @throws java.sql.SQLException if failed to insert to the screen by language table
     */
     ...
     * @throws java.sql.SQLException if failed to insert the screens to the database.
     */
     ...
     * @throws java.sql.SQLException if failed to get the position
     */
     ...
     * @throws java.sql.SQLException if failed to get the screens by program id from the database.
     */
     ...
     * @param langId    the language id
     * @return screen
     * @throws java.sql.SQLException if failed to get the screens by program and language from the database.
     */
    ...
    /**
     * @see com.agrologic.app.dao.ScreenDao#getAllProgramScreens(Long)
     */
    Collection<Screen> getAllByProgramId(Long programId) throws SQLException;

    /**
     * @see com.agrologic.app.dao.ScreenDao#getAllScreensByProgramAndLang(Long, Long, boolean)
     */
     ...
     * @throws java.sql.SQLException if failed to retrieve the screens from the database.
     */
