...
public interface WorkerDao {
     ...
     * @throws SQLException if failed to insert new worker to the database.
     */
     ...
     * @throws SQLException if failed to remove the worker from the database
     */
     ...
     * @throws SQLException if failed to retrieve the worker from the database
     */
     ...
     * @throws SQLException if failed to retrieve all workers from the database
     */
     ...
     * @throws SQLException if failed to retrieve the currency from the database
     */
