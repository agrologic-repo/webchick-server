...
public interface ProgramRelayDao {
     ...
     * @throws SQLException if failed to update the program relays
     */
     ...
     * @throws SQLException if failed to remove the program relays
     */
     ...
     * @throws SQLException if failed to insert to the program relays collection
     */
