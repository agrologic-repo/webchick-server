package com.agrologic.app.parsing;
...
public class DataParser {
    ...
    public DataParser(HashMap<Long, Data> parsedDataMap) {
     ...
     */
    public void parseShortResponse(String dataString, Message request) {
        StringTokenizer token = new StringTokenizer(dataString.toString(), " ");
