...
/**
 * The model for the Wizard component, which tracks the text, icons, and enabled state of each of the buttons, as well
 * as the current panel that is displayed. Note that the model, in its current form, is not intended to be subclassed.
 */
public class WizardModel {
    ...
    private HashMap<String, Object>                buttonEnabledHashmap;
    private HashMap<String, Object>                buttonIconHashmap;
    ...
    public WizardModel() {
        ...
        buttonIconHashmap     = new HashMap<String, Object>();
        buttonEnabledHashmap  = new HashMap<String, Object>();
