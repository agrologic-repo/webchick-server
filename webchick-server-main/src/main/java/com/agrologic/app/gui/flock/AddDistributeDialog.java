...
public class AddDistributeDialog extends JDialog {
    ...
    private Distrib getFromFields() {
        ...
        Object date = ((DefaultTableModel) tblDataTable.getModel()).getValueAt(0, 1);
        Object account = ((DefaultTableModel) tblDataTable.getModel()).getValueAt(0, 2);
        Object sex = ((DefaultTableModel) tblDataTable.getModel()).getValueAt(0, 3);
        Object taget = ((DefaultTableModel) tblDataTable.getModel()).getValueAt(0, 4);
        Object numbOfBird = ((DefaultTableModel) tblDataTable.getModel()).getValueAt(0, 5);
//        currDistrib = new Distrib();
//        currDistrib.setAccountNumber(Integer.parseInt(account));
//        currDistrib.setTarget(taget);
//        currDistrib.setSex(sex);
//        currDistrib.setNumOfBirds(Integer.parseInt(numbOfBird));
//        currDistrib.setDate((String)date);
        return currDistrib;
    }
