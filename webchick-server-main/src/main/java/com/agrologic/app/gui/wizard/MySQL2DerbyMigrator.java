 ...
 */
public class MySQL2DerbyMigrator extends javax.swing.JFrame {
    ...
    public void initLanguage() {
        LanguageDao langDao = DaoFactory.getDaoFactory(DaoType.MYSQL).getLanguageDao();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MySQL2DerbyMigrator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new MySQL2DerbyMigrator().setVisible(true);
            }
        });
    }
